...
def rectify(input_file_path_tmp, output_file_path_tmp, eo_name_tmp, image_name_tmp, pixel_size, focal_length, gsd, ground_height):
...
if __name__ == '__main__':
    rectify(input_file_path_tmp="D:\\python-workspace\\livedronemap\\utils\\workspace\\",
            output_file_path_tmp="D:\\python-workspace\\livedronemap\\utils\\workspace\\result\\",
